...
// @require 	file:///E:/Teampermonkey/AnimeFLV/animeflv-home.anime-data.js
// @require 	file:///E:/Teampermonkey/AnimeFLV/animeflv-home.animes-data.js
// @require 	file:///E:/Teampermonkey/AnimeFLV/animeflv-home.js
// @grant        none
// ==/UserScript==
...
<li class="{{dayClass}}" style="display: list-item">
	...
	</a>	<span  title="{{fecha}}" style="float: left" class="days"><small>[{{weekDay}} {{day}}]</small> {{days}}</span>
			...
			const thumb = new nhtml(thumbTpl)
				.setVal({
					...
					episodeUrl:
						...
						"-" +
						anime.episodes,
					weekDay: weekDays[anime.nextChapter.wd],
					day:anime.nextChapter.day,
				})
				.value();
